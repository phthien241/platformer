...
export default class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        // Create the score text but don't set the position yet
        this.scoreText = this.add.text(110, 150, `Score:0`, {
            fontSize: '24px',
            color: '#000',
        }).setDepth(2).setScrollFactor(0)
        // Update the score text position based on the camera's zoom and viewport
